...
const ValidasiPengajian = () => {
    return (
        // <div className='bg-bg h-screen w-screen overflow-hidden'>
            <div className='flex flex-col items-center w-[98%] ml-[80px] pt-6'>
                <h1 className='text-[30px] font-montserrat mb-7'>Validasi Pengajian Rutin</h1>
                        ...
                        <table className="table-auto w-full border-separate border-spacing-y-3">
                            <tbody className=''>
                                        <tr className='bg-[#F5F5F5] rounded-md shadow-md' >
                                            <td className="relative text-center px-10 py-2 rounded-l-lg">Jadwal Pengajian Rutin</td>
...
export default ValidasiPengajian;
