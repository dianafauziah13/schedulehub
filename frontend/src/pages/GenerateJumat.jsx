...
import ModalDeleteJumat from '../component/generate/ModalDeleteJumat';
import ModalPreviewJumat from '../component/generate/PreviewJumat';
                        ...
                        <table className="table-auto w-full border-separate border-spacing-y-3">
                            ...
                            <tbody className=''>
                                        <tr className='bg-[#F5F5F5] rounded-md shadow-md' >
                                            <td className="relative text-center px-10 py-2 rounded-l-lg">Jadwal Khutbah Jum'at</td>
